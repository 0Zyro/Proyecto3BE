...
Public Class Form2
    ...
    Private Sub ListBoxUsuarios_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LBXUsuarios.SelectedIndexChanged
        ...
        comando.CommandText = ("select * from usuario where ci='" + LBXUsuarios.SelectedItem + "'")
        ...
        Try
            ...
            If Dir$("../../Res/profile/" + reader.GetString(5) + ".bmp") <> "" Then
                PIBUsuarios.Image = Image.FromFile("../../Res/profile/" + reader.GetString(5) + ".bmp")
            Else
                PIBUsuarios.Image = Image.FromFile("../../Res/profile/default.bmp")
            End If
    ...
    Private Sub BotonEliminarUsuarios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNEliminarUsuarios.Click
        ...
        Try
            ...
            If MessageBox.Show("¿Seguro que desea eliminar a este Usuario?", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                comando.CommandText = ("update usuario set estado='inactivo' where ci='" + (LBXUsuarios.SelectedItem).ToString.Split(" ")(0) + "'")
    ...
    Private Sub estadoAgregar()
        ...
        PIBUsuarios.Image = Image.FromFile("../../Res/profile/nueva.bmp")
    ...
    Private Sub CheckBoxUsuarios_CheckStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CHBUsuarios.CheckStateChanged
        BTNBusquedaUsuarios.PerformClick()
    ...
    Private Sub PictureBoxUsuarios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PIBUsuarios.Click
        BuscarImagen()
    End Sub
